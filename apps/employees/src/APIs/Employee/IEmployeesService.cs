...
public interface IEmployeesService
{
    ...
    /// </summary>
    public Task ConnectSupervisees(EmployeeWhereUniqueInput uniqueId, EmployeeWhereUniqueInput[] employeesId);
    /// <summary>
    /// Disconnect multiple Supervisees records from Employee
    /// </summary>
    public Task DisconnectSupervisees(EmployeeWhereUniqueInput uniqueId, EmployeeWhereUniqueInput[] employeesId);
    /// <summary>
    /// Find multiple Supervisees records for Employee
    /// </summary>
    public Task<List<Employee>> FindSupervisees(EmployeeWhereUniqueInput uniqueId, EmployeeFindManyArgs EmployeeFindManyArgs);
    /// <summary>
    /// Update multiple Supervisees records for Employee
    /// </summary>
    public Task UpdateSupervisees(EmployeeWhereUniqueInput uniqueId, EmployeeWhereUniqueInput[] employeesId);
    /// <summary>
