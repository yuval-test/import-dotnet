...
public abstract class UsersServiceBase : IUsersService
{
    ...
    public UsersServiceBase(ImportDbContext context)
    {
        _context = context;
    }
    ...
    public async Task<User> CreateUser(UserCreateInput createDto)
    {
        var user = new UserDbModel
        {
            ...
            IsDisabled = createDto.IsDisabled,
            IsMainUser = createDto.IsMainUser,
            Modified = createDto.Modified,
            Modifiedby = createDto.Modifiedby,
            TrustedPhoneNumber = createDto.TrustedPhoneNumber
        };
